...
func StartAutoExecutor(quitCh chan<- int, home string, daemonPath string, seeds string, flags string, poolId int64, restEndpoint string, targetHeight int64, apiServer bool, port int64) {
	syncMode := "db"
