...
replace (
	github.com/btcsuite/btcd/btcec/v2 v2.3.4 => github.com/btcsuite/btcd/btcec/v2 v2.2.2
	github.com/tendermint/tendermint => github.com/KYVENetwork/cometbft v0.34.35
)
