...
var (
	engineLogger = EngineLogger{logger: logger.NewLogger(utils.EngineDydxCometBFT)}
)
...
func (l EngineLogger) With(keyvals ...interface{}) log.Logger {
	return EngineLogger{logger: logger.NewLogger(utils.EngineDydxCometBFT, keyvals)}
}
